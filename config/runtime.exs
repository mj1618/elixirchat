...
#
#     PHX_SERVER=true bin/elixirchat start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :elixirchat, ElixirchatWeb.Endpoint, server: true
end

config :elixirchat, ElixirchatWeb.Endpoint,
  http: [port: String.to_integer(System.get_env("PORT", "4000"))]

# OpenAI API configuration for the AI agent
...
if config_env() == :prod do
  ...
  config :elixirchat, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :elixirchat, Elixirchat.Mailer,
